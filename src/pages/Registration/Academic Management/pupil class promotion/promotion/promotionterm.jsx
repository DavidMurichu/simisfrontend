...
function PromotionTerm() {
    ...
    const fetchAllPupils = async () => {
        try {
            ...
            console.log("response of pupils", response.data)
    ...
    return (
        <MainCard title="Promotion Page" style={{ backgroundColor: 'var(--bg-color)', color: 'var(--text-color)' }}>
            <Box sx={{ mb: 2 }}>
                <Accordion>
                    <AccordionSummary
